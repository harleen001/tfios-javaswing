...
public class page_8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/faultinourstars/8.jpg"))); // NOI18N
        ...
        jLabel8.setText("about themselves and");
        IstPage.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 300, 260, 40));

        jLabel9.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("discover new truths ");
        IstPage.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 260, 290, 40));

        jLabel11.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Together, they embark ");
        ...
        jLabel12.setText("on a journey towards");
        ...
        jLabel10.setText("about each other.");
        IstPage.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 340, 260, 40));

        jLabel13.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Amsterdam where they");
        IstPage.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 220, 260, 40));
   ...
   P7.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(page_8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
