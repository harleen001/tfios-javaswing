 ...
 * @author hp
 */
public class Ist_page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/faultinourstars/1.jpg"))); // NOI18N
        IstPage.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -70, -1, -1));
        ...
        jLabel7.setText("Hazel Grace Lancaster and ");
        IstPage.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 300, 280, 40));

        jLabel8.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("by John Green that tells");
        IstPage.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 220, 260, 40));

        jLabel9.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("the story of two teenagers, ");
        IstPage.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 260, 290, 40));

        jLabel10.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("at a cancer support group.");
        IstPage.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 380, 270, 40));

        jLabel11.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("\"The Fault in Our Stars\" ");
        IstPage.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 140, 260, 40));

        jLabel12.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("is a heart-wrenching novel ");
        IstPage.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 180, 290, 40));

        jLabel13.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Augustus Waters, who meet");
        IstPage.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 340, 300, 40));
        ...
        getContentPane().add(IstPage, new org.netbeans.lib.awtextra.AbsoluteConstraints(-4, 0, 710, -1));
   ...
   wl.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ist_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
