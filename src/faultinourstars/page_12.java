...
public class page_12 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/faultinourstars/12.jpg"))); // NOI18N
        ...
        jLabel7.setText("fragility of life.");
        IstPage.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 300, 280, 40));

        jLabel8.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("leave readers thinking about");
        IstPage.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 220, 310, 40));

        jLabel9.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("the power of love and the");
        ...
        jLabel11.setText("It is a moving and thought");
        IstPage.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 140, 280, 40));

        jLabel12.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("provoking read that will");
        ...
        getContentPane().add(IstPage, new org.netbeans.lib.awtextra.AbsoluteConstraints(-4, 0, 710, 590));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        page_12 firstpage= new page_12();
        firstpage.setVisible(true);
        dispose();// TODO add your handling code here:
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
  page_13 P13= new page_13();
    P13.setVisible(true);
    dispose();
  ...
  page_11 P11= new page_11();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(page_12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
