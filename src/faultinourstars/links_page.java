 ...
 * @author hp
 */
public class links_page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/faultinourstars/840d1559c62446801ab29fd21d252225.jpg"))); // NOI18N
        IstPage.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -50, 390, -1));

        jLabel7.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Get the Background Music");
        jLabel7.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel7MouseClicked(evt);
            }
        });
        IstPage.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 380, 330, 40));

        jLabel12.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Get your Kindle Reader Now ");
        jLabel12.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel12MouseClicked(evt);
            }
        });
        IstPage.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 270, 320, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        links_page firstpage= new links_page();
  ...
  WelcomePage wp= new WelcomePage();
    ...
    try {
        ...
        Desktop.getDesktop().browse(new URI("https://www.amazon.com/Kindle-Oasis-now-with-adjustable-warm-light/dp/B07F7TLZF4/ref=sr_1_1?keywords=kindle%2Breader&sr=8-1&th=1"));
...
try {
        ...
        Desktop.getDesktop().browse(new URI("https://thinknews.com.ng/foreign-downloads/taylor-swift-all-too-well-10-minute-version-download-10/"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(links_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new links_page().setVisible(true);
            }
        });
    }
